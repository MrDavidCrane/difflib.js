...
To use it in the browser, you may download the [minified js file](https://github.com/MrDavidCrane/difflib.js/raw/master/dist/difflib-browser.js) and include it in your webpage.
